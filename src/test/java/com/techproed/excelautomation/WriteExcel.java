...
public class WriteExcel {
    ...
    public void test() throws IOException {
        ...
        // İstediğimiz SATIRI tamamiyle SILMEK için bu kodu kullanıyoruz.
        Row onuncuSatir = workbook.getSheetAt(0).getRow(10);
        workbook.getSheetAt(0).removeRow(onuncuSatir);

        // İstediğimiz HUCREYI SILMEK için bu kodu kullanıyoruz.
        ...
        workbook.write(fileOutputStream); //BU code'u yazmazsak degisiklikleri excel dosyasina UYGULAMAZ ve KAYDETMEZ
